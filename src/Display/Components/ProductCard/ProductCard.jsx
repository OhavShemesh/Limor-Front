  ...
  return (
    <Container sx={{ paddingTop: "3vh", position: "relative" }}>
      <Card sx={{ borderRadius: "20px" }}>
        ...
        <IconButton sx={{ display: "flex", position: "absolute", bottom: 20, right: rl % 2 == 0 ? 50 : "none", left: rl % 2 == 1 ? 50 : "none", alignItems: "center", gap: 1, borderRadius: "20px" }}>
          <Typography sx={{ fontFamily: "tahoma", color: "black" }}>הוסף לעגלה</Typography>
